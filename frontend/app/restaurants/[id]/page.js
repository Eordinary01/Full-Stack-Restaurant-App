    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50 flex items-center justify-center">
        <div className="flex flex-col items-center space-y-4">
          ...
          <p className="text-lg font-medium text-gray-700">Loading amazing flavors...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50 p-6">
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-xl p-6 border border-red-100">
          <div className="flex items-center space-x-4 text-red-600">
            ...
            <div>
              <h3 className="text-lg font-semibold">Error Loading Restaurant</h3>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 to-blue-50 p-6">
        <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-xl p-6">
          <div className="text-center">
            ...
            <p className="mt-2 text-gray-500">We couldn't find the restaurant you're looking for.</p>
          </div>
        </div>
      </div>
    );
          ...
          <div className="flex justify-between items-center mb-8">
            ...
            {user.role === 'owner' && (
              <div className="flex space-x-4">
                ...
                <button
                  onClick={() => router.push(`/restaurants/${restaurantId}/menu/add`)}
